...
document.addEventListener("DOMContentLoaded", function () {
	...
	function timer(id, deadline) {
		...
		function setClock(selector, endtime) {
			...
			function updateClock() {
				...
				textMinutes.innerHTML = getNoun(
					minutesUpdate,
					"минута",
					"минуты",
					"минут"
				);
				textSeconds.innerHTML = getNoun(
					secondsUpdate,
					"секунда",
					"секунды",
					"секунд"
	...
	function isSelected() {
		if (noSelect.checked == true) {
			(hoveredInput.innerHTML = ""), hoveredInput.classList.remove("");
			hoveredInput.classList.add("");
		} else if (yesSelect.checked == true) {
			hoveredInput.innerHTML =
				'<div><label for="text" class="block text-xl leading-6">На чем будете добираться?</label><div class="mt-10"><input type="radio" class="text-[#413329] focus:ring-[#413329]" id="transfer" name="road" value="transfer"/><label class="ml-1">На трансфере</label></div><div class="mt-10"><input type="radio" class="text-[#413329] focus:ring-[#413329]" id="transfer" name="road" value="own"/><label class="ml-1">Своим ходом</label></div><label for="text" class="block text-xl leading-6 mt-10">Что предпочитаете из напитков?</label><div class="mt-10"><input type="checkbox" class="rounded text-[#413329] focus:ring-[#413329]" name="drinks[whiteVine]" id="whiteVine"/><label htmlFor="whiteVine" class="ml-1">Белое вино</label></div><div class="mt-10"><input type="checkbox" class="rounded text-[#413329] focus:ring-[#413329]" name="drinks[redVine]" id="redVine"/><label htmlFor="redVine" class="ml-1">Красное вино</label></div><div class="mt-10"><input type="checkbox" class="rounded text-[#413329] focus:ring-[#413329]"  name="drinks[vodka]" id="vodka"/><label htmlFor="vodka" class="ml-1">Водка</label></div><div class="mt-10"><input type="checkbox" class="rounded text-[#413329] focus:ring-[#413329]"  name="drinks[shampane]" id="shampane"/><label htmlFor="shampane" class="ml-1">Шампанское</label></div><div class="mt-10"><input type="checkbox" class="rounded text-[#413329] focus:ring-[#413329]" name="drinks[notDrinks]" id="notDrinks" checked/><label htmlFor="notDrinks" class="ml-1">Не пью</label></div>';
